...
public class VerificationAndOrderPlacementPage extends BasePage {
	 ...
	 * 
	 * @param sectionName the name of the section can be Shipping type or Payment type
	 * @param value the value is the option previously selected 
	 * 
	 * For instance: sectionName = "Shipping type" and value = "Standard Delivery"
	 * 
	 * @return true or false
	 */
	...
	/**
	 * Validate if the product is listed on the verification and order placement page
	 * 
